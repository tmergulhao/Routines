...
extension CKRecordEncoder : Encoder {
    ...
    var record : CKRecord {
        ...
        let zoneID = self.zoneID ?? CKRecordZone.ID(zoneName: CKRecordZone.ID.defaultZoneName, ownerName: CKCurrentUserDefaultName)
...
extension CKRecordEncoder {
    ...
    final class KeyedContainer<Key> where Key : CodingKey {
        ...
        init(recordType: String, zoneID: CKRecordZone.ID?, recordName: String, codingPath: Array<CodingKey>, userInfo: Dictionary<CodingUserInfoKey, Any>)
        {
